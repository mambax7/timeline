<?php
// $Id: header.php,v 1.1.1.1 2009/03/19 14:41:43 ohwada Exp $
...
class timeline_compo_xoops_header extends timeline_base_xoops_header
{
    ...
    {
        parent::__construct($dirname, TIMELINE_TRUST_DIRNAME);
    ...
    // assign
    //---------------------------------------------------------
    public function assign_or_get_default_css($flag_template = false)
    {
    ...
    public function assign_or_get_timeline_js($flag_template = false)
    {
        $show = false;
        $js   = null;
    ...
    public function build_timeline_js()
    {
