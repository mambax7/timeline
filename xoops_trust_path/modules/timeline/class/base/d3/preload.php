<?php
// $Id: preload.php,v 1.1.1.1 2009/03/19 14:41:42 ohwada Exp $
...
//=========================================================
// class timeline_base_d3_preload
//=========================================================
class timeline_base_d3_preload
{
	var $_dh;
...
// constructor
//---------------------------------------------------------
function timeline_base_d3_preload()
{
	// dummy
}
...
function &getInstance()
{
	static $instance;
	if (!isset($instance)) {
		$instance = new timeline_base_d3_preload();
	}
	return $instance;
}
