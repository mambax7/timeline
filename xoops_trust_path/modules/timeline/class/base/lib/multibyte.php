<?php
// $Id: multibyte.php,v 1.1.1.1 2009/03/19 14:41:43 ohwada Exp $
...
//=========================================================
// class timeline_base_lib_multibyte
//=========================================================
class timeline_base_lib_multibyte
{
	var $_language;
...
// constructor
//---------------------------------------------------------
function timeline_base_lib_multibyte()
{
...
// wordwrap
//---------------------------------------------------------
function build_summary_with_wordwrap( $str, $max, $width, $break )
{
	$str = $this->build_plane_text( $str );
	...
	foreach ( $arr as $line )
	{
		$line = trim($line);
		if ( $line === '' ) continue;
		$ret .= $this->mb_wordwrap( $line, $width, $break );
	}
	return $ret ;
}
